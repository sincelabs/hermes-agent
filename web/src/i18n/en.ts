...
export const en: Translations = {
  ...
  cron: {
    ...
    search: "Search",
    searchPlaceholder: "Name, prompt, schedule or skill",
    noMatches: "No jobs match this filter.",
    editJob: "Edit job",
    saveChanges: "Save changes",
    newJobHint: "A prompt the agent runs on a schedule, on its own.",
    finishedNoRun: "This job has finished; there is nothing left to run.",
    finishedNoResume: "This job has finished; there is nothing left to resume.",
